...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_payment = "INSERT INTO payments (class, student_id, student_name, month, subject, amount, receiver) VALUES ('$class', '$student_id', '$student_name', '$month', '$subject', '$amount', '$receiver')";
