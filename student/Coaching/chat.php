...
$sql = "SELECT `full_name`, `class` FROM `students` WHERE `userid` = ?";
$stmt = mysqli_prepare($conn, $sql);
...
<body>
    ...
    <div id="chat-container">
        ...
        <div id="chat-messages">
            ...
            <?php
            $sql = "SELECT * FROM `chat` WHERE  `class` = ? OR `class` = 'null'";
            $stmt = mysqli_prepare($conn, $sql);
            mysqli_stmt_bind_param($stmt, "s", $myClass);
            mysqli_stmt_execute($stmt);
            $result = mysqli_stmt_get_result($stmt);
        ...
        <div id="chat-input">
            ...
            <form action="chat.php" method="post">
                ...
                <input type="hidden" name="class" value="<?php echo $myClass; ?>">
